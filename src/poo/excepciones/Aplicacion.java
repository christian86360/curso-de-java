...
public class Aplicacion {
    ...
    public Usuario login(String usrname , String password) throws ReflectiveOperationException, ErrorFisicoException
    {
        try
        {
        ...
        String usr=rb.getString("usuari");
        //leemos el valor de la propiedad password
        String pwd=rb.getString("password");
        //definimos la variable de retorno
        Usuario u=null;
        //si considen los datos proporcionados con los leidos
    ...
    {
        //cualquier error "salga por exepcion"
